...
public class TodoService {
    ...
    public Page<TodoResponse> getTodos(int page, int size, String weather, LocalDate startDate, LocalDate endDate) {
        ...
        if(weather == null || weather.isBlank()){
            todos = todoRepository.findByModifiedAtBetweenOrderByModifiedAtDesc(
    ...
    public Page<TodoListResponseDto> getTodosByKeyword(int page, int size, String titleKeyword, String nicknameKeyword){

        Pageable pageable = PageRequest.of(page - 1, size);

        return todoRepository.findTodoByKeyword(titleKeyword, nicknameKeyword, pageable);
    }
}
